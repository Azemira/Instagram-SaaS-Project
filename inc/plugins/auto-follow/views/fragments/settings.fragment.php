                        ...
                        <div id="very-fast" class="tabcontent" >
                         <?php $settings_tab = "very-fast" ?>
                           <?php include(__DIR__.'/settings-speed.fragment.php'); ?>
                            ...
                            <ul class="field-tips">
                                <li><?= __("These values indicates comment and delay values. They are not exact values. Depending on the server overload and delays between the requests, actual number of the requests might be less than these values.") ?></li>
