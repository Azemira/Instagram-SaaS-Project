                        ...
                        <div class="section-content">
                         ...
                         <div class="mb-20">
                                <label for="form-label"><?= __("Delay each comment per operation:") ?></label><br>
                            ...
                            <div class="mb-20">
                                <label for="form-label"><?= __("Comments Limit:") ?></label><br>
                            ...
                            <div class="mb-20">
                                <label for="form-label"><?= __("Comments Per Day Limit:") ?></label><br>
