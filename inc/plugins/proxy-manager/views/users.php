...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/".$idname."/assets/libs/sweetalert2/dist/sweetalert2.min.css?v=41".VERSION ?>">
    ...
    <body>
        ...
        <?php require_once(__DIR__.'/fragments/users.fragment.php'); ?>
        <?php require_once(__DIR__.'/fragments/proxy-variable.fragment.php'); ?>
        ...
        <script type="text/javascript" src="<?= PLUGINS_URL."/".$idname."/assets/libs/sweetalert2/dist/sweetalert2.min.js?v=".VERSION ?>"></script>
