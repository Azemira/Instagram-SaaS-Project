                ...
                <div class="col s12 m8 l4">
                    <section class="section">
                        <div class="section-content">
                            ...
                            <div class="js-checkpoint none">
                                <input type="hidden" name="checkpointid" value="" disabled>
                                ...
                                <p class="backup-note">
                                    <?=
                                    __("You should receive the 6 digit security code sent by Instagram to the mail address of this account.");
                                    ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="js-2fa js-checkpoint none">
