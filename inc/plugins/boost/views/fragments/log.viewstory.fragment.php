                            ...
                            <div class="clearfix">
                                <span class="circle">
                                    <?php if ($l->get("status") == "success"): ?>
                                        <?php $img = $l->get("data.saw.media_thumb"); ?>
                                ...
                                <div class="inner clearfix">
                                    ...
                                    <div class="action">
                                        <?php if ($l->get("status") == "success"): ?>
                                            <?php
                                                $media_type = $l->get("data.media_type.media_type");
                                                if ($media_type == 1) {
                                                    $type_label = "photo";
                                                ...
                                                $username = "<a href='https://www.instagram.com/".htmlchars($l->get("data.saw.user.username"))."' target='_blank'>".htmlchars($l->get("data.saw.user.username"))."</a>";
                                                $type_label = "<a href='https://www.instagram.com/p/".htmlchars($l->get("data.saw.media_code"))."' target='_blank'>".$type_label."</a>";

                                                echo __("seen {username}'s {post} ", [
                                                    "{username}" => $username,
                                                    "{post}" => $type_label 
                                                ]);
                                            ?>
