        ...
        <aside class="skeleton-aside hide-on-medium-and-down">
          ...
          <div class="section-header back-button-wh none">
            <a href="<?= APPURL."/e/".$idname."/" ?>">
              <span class="mdi mdi-account-circle"></span><?= __("Pick Account") ?>
            </a> 
          </div>        
                ...
                <div class="section-content">
                    ...
                    <div class="clearfix">
                        <div class="col s12 m12 l12">
                          ...
                          <!-- start: actions list -->
                          <div class="boost-box" id="boost-actions">
                          ...
                          <!-- start: search source -->
                          <div class="boost-box" id="boost-source">
                            <div class="boost-head">
                                ...
                                <div class="clearfix mb-20 pos-r wrap-search-targets">
                                  ...
                                  <div class="mb-5 clearfix">                                
                                      <div class="inline-block pull-right">
                                        <label id="boost-copy" class="inline-block tooltip tippy mr-10" data-position="top" data-size="small" title="<?= __("Copy all parameters below to use in other account or place");?>">
                                            <a class="small button button--light-outline button--oval" href="javascript:void(0)"><?= __("Copy") ?></a>
                                        </label>
                                        <label id="boost-paste" class="inline-block tooltip tippy" data-position="top" data-size="small" title="<?= __("Click here to paste copied parameters");?>">
                                            <a class="small button button--light-outline button--oval" href="javascript:void(0)"><?= __("Paste") ?></a>
                                        </label>
                                      </div>                     
                                  </div> 
                                <div class="tags clearfix mt-20 pasteBox">
                                    <?php 
                          ...
                          <!-- start: Follow + Mute -->
                          <?php if($Settings->get("data.follow_plus_mute")) : ?>
                          <div class="boost-box">
                            <div class="boost-head">
                                  ...
                                  <div class="clearfix mb-20">
                                    <div class="col s6 m6 l6">
                                      ...
                                      <div class="col s6 s-last m6 m-last l6 l-last">
                                        ...
                                        <select class="input" name="follow-plus-mute-type">
                          ...
                          if($Settings->get("data.action_unfollow")) : ?>
                          <div class="boost-box" id="boost-unfollow">
                            <div class="boost-head">
                          ...
                          <!-- start: comments -->
                          <div class="boost-box" id="boost-comments" <?= !$Settings->get("data.action_comment") ? 'style="display:none;"' : ""; ?>>
                            <div class="boost-head">
                                    ...
                                    <ul class="field-tips">
                                      ...
                                      <?php endif; ?>
                                        <li>
                                            ...
                                            <div class="mt-5">
                                                <strong id="comment_get_username" style="cursor:pointer;" title="<?= __("click to add {{username}}"); ?>">{{username}}</strong>
                                                <?= __("Media owner's username") ?>
                                            </div>
                                          
                                            <div class="mt-5">
                                                <strong id="comment_get_first_name" style="cursor:pointer;" title="<?= __("click to add {{first_name}}"); ?>">{{first_name}}</strong>
                                                <?= __("Media owner's First Name") ?>
                                            </div>
                                          
                                            <div class="mt-5">
                                                <strong id="comment_get_full_name" style="cursor:pointer;" title="<?= __("click to add {{full_name}}"); ?>">{{full_name}}</strong>
                          ...
                          <!-- start: welcomedm -->
                          <div class="boost-box" id="boost-welcomedm" <?= !$Settings->get("data.action_welcomedm") ? 'style="display:none;"' : ""; ?>>
                            <div class="boost-head">
                                    ...
                                    <ul class="field-tips">
                                      ...
                                      <?php endif; ?>
                                        <li>
                                            ...
                                            <div class="mt-5">
                                                <strong id="dm_get_username" style="cursor:pointer;" title="<?= __("click to add {{username}}"); ?>">{{username}}</strong>
                                                <?= __("Media owner's username") ?>
                                            </div>
                                          
                                            <div class="mt-5">
                                                <strong id="dm_get_first_name" style="cursor:pointer;" title="<?= __("click to add {{first_name}}"); ?>">{{first_name}}</strong>
                                                <?= __("Media owner's First Name") ?>
                                            </div>
                                          
                                            <div class="mt-5">
                                                <strong id="dm_get_full_name" style="cursor:pointer;" title="<?= __("click to add {{full_name}}"); ?>">{{full_name}}</strong>
                                                <?= __("Media owner's full name. If user's full name is not set, username will be used.") ?>
                                            </div>
                                        </li>
                                    </ul>
                          ...
                          <!-- start: blacklist -->
                          <div class="boost-box" id="boost-blacklist">
                            <div class="boost-head">
