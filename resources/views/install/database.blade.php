                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="APP_URL" value="{{ old('APP_URL', (request()->server('HTTPS') ? 'https://' : 'http://' . request()->server('HTTP_HOST'))) }}" class="form-control" placeholder="Application URL">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Database hostname</label>
                            <input type="text" name="DB_HOST" value="{{ old('DB_HOST', '127.0.0.1') }}" class="form-control" placeholder="Database hostname">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Database port</label>
                            <input type="text" name="DB_PORT" value="{{ old('DB_PORT', '3306') }}" class="form-control" placeholder="Database port">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Database name</label>
                            <input type="text" name="DB_DATABASE" value="{{ old('DB_DATABASE') }}" class="form-control" placeholder="Database name">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Database username</label>
                            <input type="text" name="DB_USERNAME" value="{{ old('DB_USERNAME') }}" class="form-control" placeholder="Database username">
                        </div>
