	                    ...
	                    <div class="col-md-4">
				            <div class="form-group">
				                ...
				                <div class="custom-controls-stacked">
				                    ...
				                    <label class="custom-control custom-radio">
				                    <input type="radio" class="custom-control-input" name="message_type" value="hashtag" {{ old('message_type') == 'hashtag' ? 'checked' : '' }}>
				                        <div class="custom-control-label">@lang('Hashtag')</div>
				                    </label>
				            ...
				            <div class="options option_hashtag" style="display: none;">
				            	<div class="row">
			                    	<div class="col-md-12 col-lg-4">
							            <div class="form-group">
							                <label class="form-label">@lang('Hashtag')</label>
											<div class="input-group">
												<span class="input-group-prepend">
													<span class="input-group-text">#</span>
												</span>
												<input type="text" name="hashtag" value="{{ old('hashtag') }}" class="form-control {{ $errors->has('hashtag') ? 'is-invalid' : '' }}">
											</div>
							                <small class="help-block">@lang('Hashtag without # symbol.')</small>
							            </div>
			                    	</div>
			                    	<div class="col-md-12 col-lg-8">
							            <div class="form-group">
							                <label class="form-label">@lang('Text')</label>
							                <div class="emoji-picker-container">
								                <textarea rows="3" name="hashtag_text" class="form-control {{ $errors->has('hashtag_text') ? 'is-invalid' : '' }}" placeholder="@lang('Compose a message to be sent')" data-emojiable="true">{{ old('hashtag_text') }}</textarea>
								            </div>
							                <small class="help-block">@lang('We also support Spintax. Feel free to use it like: {Hi|Hello|Hey} dear friend! {Thank you|We appreciate you} for your interest.')</small>
							            </div>
			                    	</div>
								...
								<div class="form-group">
									<div class="input-group">
										<select name="speed" class="form-control">
											<option value="25" {{ old('speed') == '25' ? 'selected' : '' }}>@lang('Slow (25 messages per day, every 56 minute)')</option>
											<option value="50" {{ old('speed') == '50' ? 'selected' : '' }}>@lang('Medium (50 messages per day, every 28 minute)')</option>
											<option value="100" {{ old('speed') == '100' ? 'selected' : '' }}>@lang('Fast (100 messages per day, every 14 minute)')</option>
											<option value="200" {{ old('speed') == '200' ? 'selected' : '' }}>@lang('Very fast (200 messages per day, every 7 minute)')</option>
											<option value="86400" {{ old('speed') == '86400' ? 'selected' : '' }} style="display: none;">@lang('Instantly (every 7-10 seconds)')</option>
										</select>
										<span class="input-group-append">
